...
public class SLinkedList<E extends DeepClone<E>> implements Iterable<E>
{
 ...
 { 
	 SLinkedList<E> deepClone = new SLinkedList();
 //use enhanced for loop to iterate through poly
 //for each term in polynomial
 for(E node: this) {
	 //adding new node w information from linked list to back of new list
	 //Is this creating unique values?
	 E copy=node.deepClone();
	 deepClone.addLast(copy);
 }
  return deepClone;
 }
